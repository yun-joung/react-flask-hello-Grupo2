...
const RegisterService = () => {
	...
	const [tipoMember, setTipoMember] = useState("");
	const [tipoValor, setTipoValor] = useState("");
	const [valor, setValor] = useState("");
	const [titulo, setTitulo] = useState("");
	const [detallaServicio, setDetallaServicio] = useState("");
	const [duracion, setDuracion] = useState("");
	const [revision, setRevision] = useState("");
	const [procesoServicio, setProcesoServicio] = useState("");
				...
				<Jumbotron className="whiteBox shadow-lg p-3 pt-5 pr-5 pl-5">
					<Form>
						<Form.Group controlId="exampleForm.ControlSelect1">
							...
							<Form.Control as="select" style={{ backgroundColor: "lightgray", marginBottom: "10px" }}>
							...
							<br />
							<Form.Label>
								<strong>¿Tienes un portafolio que quisieras mostrar a tus potenciales clientes?</strong>
							</Form.Label>
